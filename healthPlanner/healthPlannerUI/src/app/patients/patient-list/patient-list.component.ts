...
//import { ExistingData } from '../../../data/response'
...
export class PatientListComponent implements OnInit {
  ...
  public dialogConfig;
  public displayedColumns = ['patientName', 'postalAddress', 'gender', 'dateOfBirth', 'mailId', 'phone', 'maritalStatus', 
      ...
      .subscribe(result => {
        ...
        if (dialogResult == "yes") {
          this.service.deleteData(id).subscribe(
            response => {
              MessageBox.show(this.dialog, "Alert", 'Successfully deleted the record ' + id, MessageBoxButton.Ok, "350px")
                .subscribe(result => {
                  this.getPatientList();
                });
            },
